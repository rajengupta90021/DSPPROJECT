                ...
                children: [
                  ...
                  Align(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        SnackBarUtils.showErrorSnackBar(context, "WE ARE WORKING ON THIS  ");
                      },
                      child: Text(
                        'Forgot Password?',
                        style: TextStyle(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Login With Phone Number",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                      ),
                    ),
                  ),
                ],
